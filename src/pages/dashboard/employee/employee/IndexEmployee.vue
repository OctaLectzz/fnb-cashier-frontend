<template>
  <q-page class="q-pa-lg">
    ...
    <q-breadcrumbs>
      ...
      <q-breadcrumbs-el :label="$t('dashboard.employee.sidebar.employeeMenu')" />
    </q-breadcrumbs>

    <div class="row justify-between q-mt-xs q-mb-lg">
      <!-- Title -->
      <div class="col-sm-6 col-xs-12 flex items-center">
        <div class="text-h4 text-weight-bolder">{{ $t('dashboard.employee.sidebar.employeeMenu') }}</div>
      </div>

      <!-- Create -->
      <div class="col-sm-6 col-xs-12">
        <q-btn v-if="hasPermission('create employees')" color="primary" :label="$t('dashboard.employee.employee.createText')" class="float-right" @click="createItemDialog = true" no-caps />
