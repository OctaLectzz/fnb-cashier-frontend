<template>
  <q-page class="q-pa-lg">
    ...
    <q-breadcrumbs>
      ...
      <q-breadcrumbs-el :label="$t('dashboard.main.sidebar.categoryMenu')" />
    </q-breadcrumbs>

    <div class="row justify-between q-mt-xs q-mb-lg">
      <!-- Title -->
      <div class="col-sm-6 col-xs-12 flex items-center">
        <div class="text-h4 text-weight-bolder">{{ $t('dashboard.main.sidebar.categoryMenu') }}</div>
      </div>

      <!-- Create -->
      <div class="col-sm-6 col-xs-12">
        <q-btn v-if="hasPermission('create categories')" color="primary" :label="$t('dashboard.main.category.createText')" class="float-right" @click="createItemDialog = true" no-caps />
          ...
          <q-card class="dashboard-card q-pa-md">
            <q-card-section class="q-pb-xl">
              ...
              <div class="text-body1 q-my-md">
                ...
                <span class="text-long q-mx-xs">{{ props.row.description }}</span>
              </div>
            </q-card-section>
